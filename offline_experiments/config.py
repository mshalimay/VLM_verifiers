...
CASES = {
    ...
    "2p": {
        "eval_criterias": ["bin"],
        # "cot_parts": ["compare", "desc_compare"],
        "cot_parts": ["no_cot", "basic_cot", "desc_compare"],
        "trace_info": ["actions", "utt"],
        "k_config": [
            {"conditional": False, "expert": False, "cached_k_dir": None},
            {"conditional": False, "expert": True, "cached_k_dir": None},
